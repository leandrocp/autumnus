...
- [Warm up parsers](/operations/warm-up) during the host application's startup lifecycle, or use the CLI when a standalone build or operations step owns the cache.
