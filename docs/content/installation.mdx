...
- For local JavaScript parser assets from npm, install per-language packages such as `@lumis-sh/wasm-rust` or preset packages such as `@lumis-sh/wasm-bundle-essential`.
