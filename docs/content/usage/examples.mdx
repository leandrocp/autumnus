...
```elixir
html = Lumis.highlight!("const x = 1", formatter: {:html_inline, lang: "javascript", theme: "dracula"})
```
...
```elixir
Lumis.highlight!("const x = 1", formatter: {:html_linked, lang: "javascript", pre_class: "demo"})
```
...
```elixir
Lumis.highlight!("fn main() {}", formatter: {:terminal, lang: "rust", theme: "dracula"})
```
...
Lumis.highlight!(source, formatter: {:html_inline, lang: "elixir", theme: theme})
```
...
Lumis.highlight!(source, formatter: {:html_inline, lang: "html", theme: "dracula"})
```
...
```elixir
code = Lumis.highlight!(source, formatter: {:html_inline, lang: "elixir", theme: "dracula"})
```
