...
Lumis.highlight!(
  "fn main() {}",
  formatter: {:html_inline, lang: "rust", theme: "dracula", pre_class: "code-block"}
)
```
...
Lumis.highlight!(
  "fn main() {}",
  formatter: {:html_linked, lang: "rust", pre_class: "code-block"}
)
```
...
Lumis.highlight!(
  "fn main() {}",
  formatter: {:terminal, lang: "rust", theme: "dracula"}
)
```
...
Lumis.highlight!(
  ~s(const x = "[url=x]"),
  formatter: {:bbcode_scoped, lang: "javascript"}
)
```
