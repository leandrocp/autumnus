...
<pre class="lumis">
  <code class="language-javascript" translate="no" tabindex="0">
    <div class="line" data-line="1">
      <span class="lumis-keyword">const</span>
      <span class="lumis-variable">x</span>
    </div>
  </code>
</pre>
```
...
- `<span class="...">` carries semantic highlight classes such as `lumis-keyword` or `lumis-string`
