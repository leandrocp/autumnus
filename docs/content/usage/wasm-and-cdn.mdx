...
- the optional `@lumis-sh/lumis-native` package replaces this setup on supported Node.js platforms with one native addon containing all parsers

## Default JavaScript behavior

Without the optional native package, Lumis resolves parser WASM from jsDelivr using versioned packages.
