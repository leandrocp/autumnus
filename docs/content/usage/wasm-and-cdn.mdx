...
This works well when your app can fetch parser WASM files from the default CDN. If you need a different host or local assets, set a custom resolver first.
