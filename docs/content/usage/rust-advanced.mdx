...
Use `LineViewBuilder` when you need the structure before rendering. It runs highlighting and returns a `LineView` with spans, ranges, line data, and decorator output.
