...
- Node can also auto-load installed parser packages such as `@lumis-sh/wasm-elixir`
- browser usage usually relies on remote parser assets unless you override the resolver or use `withWasm()` with an npm parser package
