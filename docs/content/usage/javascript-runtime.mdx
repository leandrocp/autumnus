...
Lumis still uses `web-tree-sitter` in the JavaScript runtime, but Edge runtimes are not supported yet because of an upstream Tree-sitter limitation: [tree-sitter/tree-sitter#2160](https://github.com/tree-sitter/tree-sitter/issues/2160).
:::
