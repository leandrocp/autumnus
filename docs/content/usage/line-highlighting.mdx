...
```bash
lumis highlight main.rs --formatter html-inline
```

Line highlighting is not currently exposed by the CLI.

  </TabItem>
</Tabs>

In Rust, use [`LineViewBuilder`](/usage/line-view-decorations) when line highlighting is part of a custom renderer or editor-like view.
...
| Terminal | no formatter-owned line highlighting |
