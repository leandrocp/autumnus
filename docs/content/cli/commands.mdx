...
Pre-download exact, integrity-checked parser WASM files so highlighting doesn't
trigger downloads at runtime.
...
Refresh cached parsers at the versions pinned by this Lumis CLI release.
