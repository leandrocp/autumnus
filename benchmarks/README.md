...
| Lumis JS WASM (1 language) | npm production closure plus Rust parser | 9.69 MiB | 2.02 MiB |
...
| highlight.js 11.11.1 | npm production closure | 5.18 MiB | 818.43 KiB |
| Lumis Rust | stripped 10-language benchmark executable | 7.11 MiB | 1.43 MiB |
| syntect 5.3.0 | stripped default-syntax benchmark executable | 1.28 MiB | 756.70 KiB |
