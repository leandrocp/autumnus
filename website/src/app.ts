    ...
    <section class="relative pt-36 pb-20 sm:pt-48 sm:pb-28">
      ...
      <div class="pointer-events-none relative z-10 mx-auto max-w-4xl px-6 text-center [&_a]:pointer-events-auto [&_button]:pointer-events-auto [&_select]:pointer-events-auto">
        ...
        <div class="mx-auto mt-6 max-w-lg">
          <div class="flex justify-center border-b border-zinc-200 dark:border-zinc-800">
            <button data-install="cli" class="install-tab cursor-pointer border-b-2 border-zinc-900 px-4 py-2 font-mono text-xs tracking-wider text-zinc-900 uppercase dark:border-white dark:text-white">cli</button>
            <button data-install="rust" class="install-tab cursor-pointer border-b-2 border-transparent px-4 py-2 font-mono text-xs tracking-wider text-zinc-400 uppercase hover:text-zinc-600 dark:hover:text-zinc-300">cargo</button>
            <button data-install="javascript" class="install-tab cursor-pointer border-b-2 border-transparent px-4 py-2 font-mono text-xs tracking-wider text-zinc-400 uppercase hover:text-zinc-600 dark:hover:text-zinc-300">npm</button>
            <button data-install="browser" class="install-tab cursor-pointer border-b-2 border-transparent px-4 py-2 font-mono text-xs tracking-wider text-zinc-400 uppercase hover:text-zinc-600 dark:hover:text-zinc-300">cdn</button>
            <button data-install="elixir" class="install-tab cursor-pointer border-b-2 border-transparent px-4 py-2 font-mono text-xs tracking-wider text-zinc-400 uppercase hover:text-zinc-600 dark:hover:text-zinc-300">hex</button>
            <button data-install="java" class="install-tab cursor-pointer border-b-2 border-transparent px-4 py-2 font-mono text-xs tracking-wider text-zinc-400 uppercase hover:text-zinc-600 dark:hover:text-zinc-300">maven</button>
          </div>
          <div class="border-x border-b border-zinc-200 dark:border-zinc-800">
            <div data-install-panel="cli" class="flex items-center justify-between px-4 py-3">
              <code class="font-mono text-sm text-zinc-700 dark:text-zinc-300"><span class="mr-2 text-zinc-400 select-none">&gt;</span>cargo install lumis-cli</code>
            ...
            <div data-install-panel="rust" class="hidden flex items-center justify-between px-4 py-3">
            ...
            <div data-install-panel="javascript" class="hidden flex items-center justify-between px-4 py-3">
            ...
            <div data-install-panel="browser" class="hidden flex items-center justify-between px-4 py-3">
              <code class="font-mono text-sm text-zinc-700 dark:text-zinc-300"><span class="mr-2 text-zinc-400 select-none">&gt;</span>unpkg.com/@lumis-sh/lumis</code>
          ...
          <div class="flex gap-1 border-b border-zinc-200 dark:border-zinc-800" role="tablist">
            ${QUICKSTART_TABS.map(
              ...
              <button role="tab" data-tab="${tab.id}" aria-selected="${i === 0}"
                class="quickstart-tab cursor-pointer border-b-2 px-4 py-2 font-mono text-xs tracking-wider uppercase transition-colors
