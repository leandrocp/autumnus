...
//!
//! See [html_multi_themes_manual.rs](https://github.com/leandrocp/lumis/blob/main/examples/rust/html_multi_themes_manual.rs)
//! and `examples/rust/html_multi_themes_manual.html` for a demo.
//!
