...
> **This crate is deprecated.** Please use [`lumis`](https://crates.io/crates/lumis) instead.
>
...
- **DEPRECATED**: Crate renamed to `lumis`. This version re-exports all types from `lumis` with deprecation warnings.
