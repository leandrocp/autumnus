...
fn gen_themes_md() -> Result<()> {
    ...
    let mut docs_md = vec![
        ...
        "# Themes".to_string(),
        String::new(),
        "Source: [`THEMES.md`](https://github.com/leandrocp/lumis/blob/main/THEMES.md).".to_string(),
        String::new(),
        ...
        String::new(),
        "For usage examples, see [Themes](/themes) and [CSS Theme Files](/themes/css-files).".to_string(),
        String::new(),
    ];
