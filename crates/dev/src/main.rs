...
fn ensure_repo_clone(
    repo_clones: &mut BTreeMap<String, String>,
    tmp: &str,
    info: &QueryInfo,
) -> Result<String> {
    ...
    Ok(repo_clones[&clone_key].clone())
}
...
fn fetch_queries(name: &str) -> Result<()> {
    ...
    for query_name in query_names()? {
        ...
        let clone_dir = ensure_repo_clone(&mut repo_clones, &tmp, info)?;
...
fn gen_languages_md() -> Result<()> {
    ...
    let mut lines = vec![
        ...
        String::new(),
            "> This file is auto-generated by `just docs-gen-languages-md`. Do not edit.".to_string(),
        String::new(),
